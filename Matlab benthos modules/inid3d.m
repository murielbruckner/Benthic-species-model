...
% Author: M. Bruckner
% Date 17/1/2021
% Reading Delft3D data into workspace
...
if Restart==1
    hydr_timestep = Total_sim_time/(years*t_eco_year);    % hydrological minutes of one ets
else
    hydr_timestep = Total_sim_time/(years*t_eco_year+1);  % hydrological minutes of one ets
end
